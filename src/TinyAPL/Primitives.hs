...
greaterEqual = PrimitiveFunction (Just $ withCoreExtraArgs1 F.lastCell) (Just $ withCoreExtraArgs2 F.greaterEqual') [G.greaterEqual] Nothing
greater = PrimitiveFunction (Just $ withCoreExtraArgs1 F.firstCell) (Just $ withCoreExtraArgs2 F.greater') [G.greater] Nothing
...
ravel = PrimitiveFunction (Just $ const F.ravel') (Just $ withCoreExtraArgs2 F.laminate) [G.ravel] Nothing
reverse = PrimitiveFunction (Just $ const F.reverse') (Just $ withCoreExtraArgs2 F.rotate') [G.reverse] Nothing
...
indices = PrimitiveFunction (Just $ withCoreExtraArgs1 F.indices) (Just $ withCoreExtraArgs2 F.intervalIndex) [G.indices] Nothing
...
roll = PrimitiveFunction (Just $ withCoreExtraArgs1 F.roll') (Just $ withCoreExtraArgs2 F.deal') [G.roll] Nothing
squad = PrimitiveFunction Nothing (Just $ withCoreExtraArgs2 F.squad) [G.squad] Nothing
...
transpose = PrimitiveFunction (Just $ withCoreExtraArgs1 F.transpose) (Just $ withCoreExtraArgs2 F.dyadicTranspose') [G.transpose] Nothing
...
decode = PrimitiveFunction (Just $ withCoreExtraArgs1 F.decodeBase2) (Just $ withCoreExtraArgs2 F.decode') [G.decode] Nothing
encode = PrimitiveFunction (Just $ withCoreExtraArgs1 F.encodeBase2) (Just $ withCoreExtraArgs2 F.encode') [G.encode] Nothing
histogram = PrimitiveFunction (Just $ withCoreExtraArgs1 F.histogram) (Just $ withCoreExtraArgs2 F.count) [G.histogram] Nothing
