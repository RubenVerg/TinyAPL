...
equal = PrimitiveFunction (FunctionCalls (Just $ withCoreExtraArgs1 F.classify') (Just $ withCoreExtraArgs2 F.equal') Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing) [G.equal] Nothing
...
rho = PrimitiveFunction (FunctionCalls (Just $ const F.shape') (Just $ const F.reshape') (Just $ withCoreExtraArgs1 F.unShape') Nothing Nothing Nothing Nothing Nothing (Just $ const F.underShapeForward) (Just $ const F.underShapeBack)) [G.rho] Nothing
...
mean = PrimitiveAdverb
  { adverbRepr = [G.mean]
  , adverbContext = Nothing
  , adverbOnNoun = Just $ const $ \x -> pure $ DerivedFunctionNoun (FunctionCalls (Just $ const $ F.powerMean' x) Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing) Nothing mean x
  , adverbOnFunction = Just $ const $ \f -> pure $ DerivedFunctionFunction (FunctionCalls (Just $ const $ F.fMean' (callMonad f []) (callUn f [])) Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing) Nothing mean f }
...
atop = PrimitiveConjunction
  ...
  , conjOnNounFunction = Just $ \_ x g -> pure $ DerivedFunctionNounFunction (FunctionCalls (Just $ \_ y -> callDyad g [] x y) Nothing (Just $ \_ y -> callAnti g [] x y) Nothing Nothing Nothing Nothing Nothing Nothing Nothing) Nothing atop x g
  , conjOnFunctionNoun = Just $ \_ f y -> pure $ DerivedFunctionFunctionNoun (FunctionCalls (Just $ \_ x -> callDyad f [] x y) Nothing (Just $ \_ x -> callContra f [] x y) Nothing Nothing Nothing Nothing Nothing Nothing Nothing) Nothing atop f y
...
over = PrimitiveConjunction
  ...
  , conjContext = Nothing
  , conjOnNounNoun = Nothing
  , conjOnNounFunction = Just $ \_ x g -> pure $ DerivedFunctionNounFunction (FunctionCalls (Just $ \_ y -> callDyad g [] x y) (Just $ \_ x' y -> callDyad g [] x' y) (Just $ \_ y -> callAnti g [] x y) (Just $ \_ x' y -> callAnti g [] x' y) Nothing Nothing Nothing Nothing Nothing Nothing) Nothing over x g
  , conjOnFunctionNoun = Just $ \_ f y -> pure $ DerivedFunctionFunctionNoun (FunctionCalls (Just $ \_ x -> callDyad f [] x y) (Just $ \_ x y' -> callDyad f [] x y') (Just $ \_ x -> callContra f [] x y) Nothing (Just $ \_ x y' -> callContra f [] x y') Nothing Nothing Nothing Nothing Nothing) Nothing over f y
...
repeat = PrimitiveConjunction
  ...
  , conjOnNounNoun = Nothing
  , conjOnNounFunction = Nothing
  , conjOnFunctionNoun = Just $ \ea f y -> pure $ DerivedFunctionFunctionNoun (FunctionCalls (Just $ \ea' -> withCoreExtraArgs1 (\cea -> F.repeat1 cea (callMonad f []) (callUn f []) y) (ea' ++ ea)) (Just $ \ea' -> withCoreExtraArgs2 (\cea -> F.repeat2 cea (callDyad f []) (callAnti f []) y) (ea' ++ ea)) (Just $ \ea' -> withCoreExtraArgs1 (\cea -> F.repeat1 cea (callUn f []) (callMonad f []) y) (ea' ++ ea)) (Just $ \ea' -> withCoreExtraArgs2 (\cea -> F.repeat2 cea (callAnti f []) (callDyad f []) y) (ea' ++ ea)) (Just $ \ea' -> withCoreExtraArgs2 (\cea -> F.commute $ F.repeat2 cea (F.commute $ callContra f []) (F.commute $ callDyad f []) y) (ea' ++ ea)) Nothing Nothing Nothing Nothing Nothing) Nothing TinyAPL.Primitives.repeat f y
...
lev = PrimitiveConjunction
  ...
  , conjOnFunctionNoun = Just $ \_ f y -> pure $ DerivedFunctionFunctionNoun (FunctionCalls (Just $ callMonad f) (Just $ callDyad f) (Just $ callUn f) (Just $ callAnti f) (Just $ callContra f) (Just $ callDis f) (Just $ callBi f) (Just $ callAna f) (Just $ callUnderForwardOrMonad f) (Just $ callUnderBackOrUn f)) Nothing lev f y
  , conjOnFunctionFunction = Just $ \_ f g -> pure $ DerivedFunctionFunctionFunction (FunctionCalls (Just $ callMonad f) (Just $ callDyad f) (Just $ callUn f) (Just $ callAnti f) (Just $ callContra f) (Just $ callDis f) (Just $ callBi f) (Just $ callAna f) (Just $ callUnderForwardOrMonad f) (Just $ callUnderBackOrUn f)) Nothing lev f g }
dex = PrimitiveConjunction
  ...
  , conjOnNounFunction = Just $ \_ x g -> pure $ DerivedFunctionNounFunction (FunctionCalls (Just $ callMonad g) (Just $ callDyad g) (Just $ callUn g) (Just $ callAnti g) (Just $ callContra g) (Just $ callDis g) (Just $ callBi g) (Just $ callAna g) (Just $ callUnderForwardOrMonad g) (Just $ callUnderBackOrUn g)) Nothing dex x g
  ...
  , conjOnFunctionFunction = Just $ \_ f g -> pure $ DerivedFunctionFunctionFunction (FunctionCalls (Just $ callMonad g) (Just $ callDyad g) (Just $ callUn g) (Just $ callAnti g) (Just $ callContra g) (Just $ callDis g) (Just $ callBi g) (Just $ callAna g) (Just $ callUnderForwardOrMonad g) (Just $ callUnderBackOrUn g)) Nothing dex f g }
...
contextualUnder = PrimitiveConjunction
  ...
  , conjContext = Nothing
  , conjOnNounNoun = Nothing
  , conjOnNounFunction = Just $ \_ x g -> pure $ DerivedFunctionNounFunction (FunctionCalls (Just $ const $ F.contextualUnderK (callUnderForwardOrMonad g []) x (callUnderBackOrUn g [])) Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing) Nothing contextualUnder x g
  , conjOnFunctionNoun = Nothing
  , conjOnFunctionFunction = Just $ \_ f g -> pure $ DerivedFunctionFunctionFunction (FunctionCalls (Just $ const $ F.contextualUnder (callUnderForwardOrMonad g []) (callMonad f []) (callUnderBackOrUn g [])) (Just $ const $ F.contextualUnder2 (callUnderForwardOrMonad g []) (callDyad f []) (callUnderBackOrUn g [])) Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing) Nothing contextualUnder f g }
