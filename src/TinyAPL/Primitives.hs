...
execute = PrimitiveFunction (Just $ const F.execute') Nothing (Just $ const $ pure . vector . fmap Character . arrayRepr) Nothing Nothing Nothing Nothing Nothing [G.execute] Nothing
