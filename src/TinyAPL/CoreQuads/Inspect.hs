...
inspectF :: Function
inspectF = PrimitiveFunction (FunctionCalls (Just $ const inspectMonad) (Just $ const inspect') Nothing Nothing Nothing Nothing Nothing Nothing) (G.quad : "Inspect") Nothing
