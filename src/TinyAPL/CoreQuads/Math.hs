...
complementaryF = PrimitiveFunction (FunctionCalls (Just $ const $ scalarMonad complementaryS) Nothing Nothing Nothing Nothing Nothing Nothing Nothing) "Complementary" Nothing
...
sinF :: Function
sinF = PrimitiveFunction (FunctionCalls (Just $ const $ scalarMonad sinS) Nothing Nothing Nothing Nothing Nothing Nothing Nothing) "Sin" Nothing
...
arcsinF :: Function
arcsinF = PrimitiveFunction (FunctionCalls (Just $ const $ scalarMonad arcsinS) Nothing Nothing Nothing Nothing Nothing Nothing Nothing) "Arcsin" Nothing
...
cosF :: Function
cosF = PrimitiveFunction (FunctionCalls (Just $ const $ scalarMonad cosS) Nothing Nothing Nothing Nothing Nothing Nothing Nothing) "Cos" Nothing
...
arccosF :: Function
arccosF = PrimitiveFunction (FunctionCalls (Just $ const $ scalarMonad arccosS) Nothing Nothing Nothing Nothing Nothing Nothing Nothing) "Arccos" Nothing
...
tanF :: Function
tanF = PrimitiveFunction (FunctionCalls (Just $ const $ scalarMonad tanS) Nothing Nothing Nothing Nothing Nothing Nothing Nothing) "Tan" Nothing
...
arctanF :: Function
arctanF = PrimitiveFunction (FunctionCalls (Just $ const $ scalarMonad arctanS) Nothing Nothing Nothing Nothing Nothing Nothing Nothing) "Arctan" Nothing
...
sinhF :: Function
sinhF = PrimitiveFunction (FunctionCalls (Just $ const $ scalarMonad sinhS) Nothing Nothing Nothing Nothing Nothing Nothing Nothing) "Sinh" Nothing
...
arsinhF :: Function
arsinhF = PrimitiveFunction (FunctionCalls (Just $ const $ scalarMonad arsinhS) Nothing Nothing Nothing Nothing Nothing Nothing Nothing) "Arsinh" Nothing
...
coshF :: Function
coshF = PrimitiveFunction (FunctionCalls (Just $ const $ scalarMonad coshS) Nothing Nothing Nothing Nothing Nothing Nothing Nothing) "Cosh" Nothing
...
arcoshF :: Function
arcoshF = PrimitiveFunction (FunctionCalls (Just $ const $ scalarMonad arcoshS) Nothing Nothing Nothing Nothing Nothing Nothing Nothing) "Arcosh" Nothing
...
tanhF :: Function
tanhF = PrimitiveFunction (FunctionCalls (Just $ const $ scalarMonad tanhS) Nothing Nothing Nothing Nothing Nothing Nothing Nothing) "Tanh" Nothing
...
artanhF :: Function
artanhF = PrimitiveFunction (FunctionCalls (Just $ const $ scalarMonad artanhS) Nothing Nothing Nothing Nothing Nothing Nothing Nothing) "Artanh" Nothing
