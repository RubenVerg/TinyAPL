...
* <primitive key="pair" />&nbsp;and&nbsp;<primitive key="singleton" />&nbsp;are both `,○⊂`
...
* <primitive key="greatest_common_divisor" />&nbsp;is `{ 0=⍺|⍵: ⍺ ⋄ ⍵ ∇⍨ ⍺|⍵ }⌓`
* <primitive key="least_common_multiple" />&nbsp;is `×«÷»⩔`
