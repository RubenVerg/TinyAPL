...
Left argument is a type (as per [`⎕FFI`](/docs/quad/ffi)), right argument is a value compatible with that type. Allocates memory and stores that value. Returns the pointer as a pointer object.
